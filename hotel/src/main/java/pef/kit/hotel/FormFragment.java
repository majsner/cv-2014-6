...
//        dynamicky omezení 1 - 30
        Spinner days = (Spinner) view.findViewById(R.id.days);
        Integer[] daysArray = new Integer[30];
        for(int i = 0;i<=29;i++){
            daysArray[i] = (i+1);
        }
        ArrayAdapter<Integer> spinnerArrayAdapter = new ArrayAdapter<Integer>(getActivity(), android.R.layout.simple_spinner_item, daysArray);
